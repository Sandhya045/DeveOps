...
public class AccountTest {
	...
	/*
	 * deposit amount
	 * 1.when the invalid account number is entered then system should throw exception
	 * 2.when the valid account number and deposit amount is entered, then amount deposited successfully
	 */
	
	@Test(expected=com.capgemini.exceptions.InvalidAccountNumberException.class)
	public void whenInvalidAccountNumberEnteredShouldThrowException() throws InvalidAccountNumberException
	{
		accountService.depositAmount(101, 2000);
	}
	
	@Test
	public void whenValidAccountNumberAndDepositAmountEnteredDepositedSuccessfully() throws InvalidAccountNumberException
	{
		Account account =new Account();
		account.setAccountNumber(101);
		account.setAmount(5000);
